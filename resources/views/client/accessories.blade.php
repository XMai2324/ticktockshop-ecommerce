        ...
        <div class="col-3">
          <div class="product-card">
            <a href="javascript:void(0)"
               ...
               data-id="{{ $strap->id }}"
               data-type="straps">
              <img src="{{ asset('storage/accessories/straps/' . $strap->image) }}"
                   alt="{{ $strap->name }}" class="product-image">
        ...
        <div class="col-3">
          <div class="product-card">
            <a href="javascript:void(0)"
               ...
               data-id="{{ $box->id }}"
               data-type="boxes">
              <img src="{{ asset('storage/accessories/boxes/' . $box->image) }}"
                   alt="{{ $box->name }}" class="product-image">
        ...
        <div class="col-3">
          <div class="product-card">
            <a href="javascript:void(0)"
               ...
               data-id="{{ $glass->id }}"
               data-type="glass">
              <img src="{{ asset('storage/accessories/glass/' . $glass->image) }}"
                   alt="{{ $glass->name }}" class="product-image">
