(() => {
    ...
    const isAuthed = () =>
        typeof IS_AUTHENTICATED !== "undefined"
            ? !!IS_AUTHENTICATED
    ...
    modal?.addEventListener("click", (e) => {
        if (
            e.target.dataset.close === "coupon-modal" ||
    ...
    $("#coupon-list")?.addEventListener("click", async (e) => {
        ...
        try {
            ...
            if (!res.ok)
                throw new Error(data.message || "Không áp dụng được mã");
            ...
            if (discountP) {
                ...
                discountP.innerHTML =
                    "-" + vn(data.discount_amount) + " <sup>đ</sup>";
            }
            // cập nhật tổng
    ...
    (function requireLoginOnSubmit() {
        ...
        form?.addEventListener("submit", (e) => {
            ...
            const cartCount = parseInt(form.dataset.cartCount || "0", 10);
